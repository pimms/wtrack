...
public class Button: UIButton {
    ...
    private func setAsLink(title: String) {
        ...
        disabledAttributedTitle.addAttribute(NSAttributedString.Key.foregroundColor, value: style.disabledTextColor ?? UIColor.defaultText, range: textRange)
